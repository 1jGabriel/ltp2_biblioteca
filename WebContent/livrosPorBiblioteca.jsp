...
<body>
	...
	<div align="center">
		<table border="5" cellpadding="10"
			...
			<%
				Object idBiblioteca = session.getAttribute("idBiblioteca");				
				ArrayList<Livro> listaLivros = new LivroDAO()
						.consultarLivrosPorBiblioteca(new Integer(idBiblioteca.toString()));
				;
